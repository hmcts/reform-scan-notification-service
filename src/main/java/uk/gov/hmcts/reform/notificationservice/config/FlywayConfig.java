...
/**
 * The `FlywayConfig` class in Java configures Flyway migrations and provides a bean to
 * check for pending migrations based on specified conditions.
 */
...
public class FlywayConfig {
    ...
    /**
     * This function checks if all Flyway migrations have been applied and throws an exception if there are pending
     * migrations.
     *
     ...
     *      created and it will check if all migrations have been applied. If there are any pending migrations,
     *      a `PendingMigrationException` will be thrown with the details of the pending migration.
     */
    @Bean
